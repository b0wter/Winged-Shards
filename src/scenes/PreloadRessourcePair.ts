...
export class FullRessourceList extends PreloadRessourceList
{
    constructor()
    {
        ...
        this.addTilemap('defense_01_room_001_map',  'maps/defense_01_room_001.json')
        ...
        // --- MISSILES ---
        this.addImage('small-missile', 'images/missiles/small-missile.png')
        ...
        this.addImage('particle_red_mini', 'images/effects/particle-red-mini.png')
